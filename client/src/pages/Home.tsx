              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (item.label !== "Overview") notify(`${item.label} is ready for the next build.`);
                  }}
